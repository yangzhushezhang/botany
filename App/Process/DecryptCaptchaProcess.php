...
class DecryptCaptchaProcess extends AbstractProcess
{
        ...
        go(function () {
            while (true) {
                try {
                    ...
                    Tools::WriteLogger(0, 2, "DecryptCaptchaProcess 进程 异常:" . $exception->getMessage(), "", 5);
                }
    ...
    {
        Tools::WriteLogger(0, 2, "进程 DecryptCaptchaProcess 异常:" . $throwable->getMessage());
    ...
    {
        Tools::WriteLogger(0, 2, "进程 DecryptCaptchaProcess  onShutDown");
