...
class UserBase extends Controller
{
    ...
    protected $who;
    protected $white_router = array('/user/login','/user/TheWorldTree','/user/get_token_mayFail');
    ...
    function WriteLogger($user_id, $kind, $content, $account_number_id = 0, $variety = 0)
    {
        try {
